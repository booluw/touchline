...
<template>
  <DrawerRoot :defaultOpen="true" @update:open="(e: boolean) => emit('close', e)">
    <DrawerPortal>
      <DrawerOverlay class="fixed top-0 inset-0 z-30 bg-black/40 flex justify-end">
        <DrawerContent class="bg-void-950 h-full" :class="[size, padded ? 'p-5' : undefined]">
          <div class="flex justify-between pb-3 mb-5 border-b border-void-600">
            <div class="font-mono">
