<template>
  <div>
    <nav class="border-b border-slate-800 bg-slate-950 px-5 py-3 text-sm">
      <div class="mx-auto flex max-w-5xl gap-5 text-slate-300">
        <NuxtLink to="/" class="font-bold text-white">Touchline</NuxtLink>
