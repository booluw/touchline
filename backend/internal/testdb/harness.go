...
func New(t *testing.T) *pgxpool.Pool {
	...
	if _, err := pool.Exec(context.Background(),
		`TRUNCATE TABLE river.river_job, world.events, world.worlds, world.countries,
		 ...
		 player.player_condition, player.contracts, player.player_history, player.injuries,
		 player.player_appearances, player.player_transfer_requests,
		 social.relationships, social.messages, social.promises,
		 social.trust_events, social.relationship_events,
