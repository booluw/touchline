...
type Service interface {
	GetWorld(id uuid.UUID) (*World, error)
	GetEvents(worldID uuid.UUID, limit int) ([]*WorldEvent, error)
	PublishEvent(event *WorldEvent) error
	GetConfig(worldID uuid.UUID) (*WorldConfig, error)
}
